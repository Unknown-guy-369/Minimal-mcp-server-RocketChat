...
import { tool } from "../src/tools/post_api_v1_channels_create.js";
import { rcClient } from "../src/rc-client.js";

describe("Tool: post_api_v1_channels_create", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it("exports correct name and description", () => {
    expect(tool.name).toBe("post_api_v1_channels_create");
    expect(tool.description).toBe("channels.new(name:o, [members:o], [readOnly:o], [excludeSelf:o], [customFields:o], [extraData:o])");
  });
  ...
  it("calls rcClient.request with correct method, path, and payload", async () => {
    ...
    let expectedPath = "/api/v1/channels.create";
